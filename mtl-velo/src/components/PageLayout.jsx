...
const PageLayout = ({ title, itemTotal, filters, children }) => {
  return (
    ...
    <div className="flex flex-col md:flex-row gap-6 p-4">
      ...
      {filters && (
        <aside className="w-full md:w-1/4 bg-white p-5 rounded-lg shadow-sm border border-mtl-texte/20 h-fit">
          <h2 className="text-xl font-bold mb-4 text-mtl-texte">Filtres</h2>
          {filters}
        </aside>
      )}
