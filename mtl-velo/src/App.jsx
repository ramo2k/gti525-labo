  ...
  return (
    <Router>
      <div className="flex flex-col min-h-screen bg-slate-50 text-slate-900">
        ...
        {/* T1.4: Contenu principal max 1280px (max-w-7xl) et HTML sémantique */}
        <main className="flex-grow w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
          <Routes>
            ...
            <Route path="/statistiques" element={<h1 className="text-3xl font-bold">Statistiques</h1>} />
            <Route path="/poi" element={<h1 className="text-3xl font-bold">Points d'intérêt</h1>} />
